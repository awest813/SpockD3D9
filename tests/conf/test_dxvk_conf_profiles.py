...
# Dragon Age: Origins, Galactic Civilizations II, and Oblivion are the Windows
# D3D9/macOS compatibility targets.
REQUIRED_PROFILES = {
    ...
    os.path.join("tools", "oblivion", "oblivion.dxvk.conf"),
